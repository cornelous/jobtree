...
class Jobify_Widget_Resume_File extends Jobify_Widget {
	...
	function widget( $args, $instance ) {
		...
		<a rel="nofollow" href="<?php echo function_exists( 'get_resume_file_download_url' ) ? esc_url( get_resume_file_download_url() ) : esc_url( $resume_file ); ?>" class="resume-file resume-file-<?php echo substr( strrchr( $resume_file, '.' ), 1 ); ?>"><?php printf( __( 'Resume.%s', 'jobify' ), substr( strrchr( $resume_file, '.' ), 1 ) ); ?></a>
